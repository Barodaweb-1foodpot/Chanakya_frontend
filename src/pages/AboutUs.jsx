          ...
          <div className="container">
              ...
              <div className="container mt-10 mb-9">
                <Row className=" align-items-center mb-10">
                  ...
                  <Col md={6} className=" pl-lg-8 mb-8">
                    <h4 className="title text-left">About The Direct Deals</h4>
                    <p className="mb-6">Text will be coming soon...</p>
                  </Col>
                </Row>
              </div>
            </section>
            ...
            <section className="customer-service pt-10 mb-7">
              <Row className="align-items-center">
                  ...
                  <div className="accordion accordion-simple accordion-plus">
                    ...
                    <div className="card border-no">
                      <div className="card-header">
                        <Link to="#collapse3-1" className={activeIndex === 1 ? 'collapse' : 'expand'} onClick={() => toggleAccordion(1)}>
                          Vision
                        </Link>
                      </div>
                      <div className={`card-body ${activeIndex === 1 ? 'expanded' : 'collapsed'}`} id="collapse3-1">
                        <p className="mb-0 descriptionVison">Text will be coming soon...</p>
                      </div>
                    </div>
                    ...
                    <div className="card descriptionVison">
                      <div className="card-header">
                        <Link to="#collapse3-2" className={activeIndex === 2 ? 'collapse' : 'expand'} onClick={() => toggleAccordion(2)}>
                          Mission
                        </Link>
                      </div>
                      <div className={`card-body ${activeIndex === 2 ? 'expanded' : 'collapsed'}`} id="collapse3-2">
                        <p className="mb-0 descriptionVison">Text will be coming soon...</p>
                      </div>
                    </div>
                    ...
                    <div className="card">
                      <div className="card-header descriptionVison">
                        <Link to="#collapse3-3" className={activeIndex === 3 ? 'collapse' : 'expand'} onClick={() => toggleAccordion(3)}>
                          Core Values
                        </Link>
                      </div>
                      <div className={`card-body ${activeIndex === 3 ? 'expanded' : 'collapsed'}`} id="collapse3-3">
                ...
                <Col md={6} className="mb-8">
                  <figure className="br-lg">
                    <img src={AboutImg} alt="Banner" style={{ backgroundColor: '#CECECC' }} />
                  </figure>
                </Col>
              </Row>
            </section>
                  ...
                  <div className="swiper-slide counter-wrap">
                    <VisibilitySensor onChange={(isVisible) => onVisibilityChange(isVisible, 'branch')} delayedCall>
                      <div className="counter text-center">
                        {viewed.branch && (
                          <>
                            <span><CountUp start={0} end={15} duration={2} /></span>
                            <span>M+</span>
                          </>
                        )}
                  ...
                  <div className="swiper-slide counter-wrap">
                    <VisibilitySensor onChange={(isVisible) => onVisibilityChange(isVisible, 'dealer')} delayedCall>
                      <div className="counter text-center">
                        {viewed.dealer && (
                          <>
                            <span><CountUp start={0} end={100} duration={2} /></span>
                            <span>M+</span>
                          </>
                        )}
